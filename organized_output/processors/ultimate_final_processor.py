#!/usr/bin/env python3
"""
Ultimate Final Processor - Capture ALL remaining fields to reach 60%+ efficiency
"""
...
def extract_all_remaining_fields_from_json(json_data: Dict) -> Dict[str, Any]:
    """Extract ALL fields including the remaining high-impact ones"""
    scheme = {}
    ...
    # NEW: Brief Description (118,128 words potential - BIGGEST MISSING FIELD!)
    ...
    # NEW: Enhanced Definitions - Extract ALL schemeDefinitions (40,000+ words potential)
    ...
    for key, value in scheme_content.items():
        if key not in [
            ...
            'benefitTypes', 'schemeImageUrl', 'briefDescription'
        ]:
...
def generate_ultimate_final_description(scheme: Dict[str, Any]) -> str:
    """Generate description with ALL extracted content - ULTIMATE FINAL TEMPLATE"""
    template_parts = []
    ...
    # Enhanced Definitions (ALL schemeDefinitions)
...
def process_single_scheme(input_file: Path, output_dir: Path) -> Dict[str, Any]:
    """Process a single scheme file with ultimate final extraction"""
    result = {
        'success': False,
        'scheme_name': 'Unknown',
        'error': None,
    ...
    try:
        ...
        # Extract ALL remaining fields from scheme data
        scheme = extract_all_remaining_fields_from_json(json_data)
        ...
        description = generate_ultimate_final_description(scheme)
...
def process_all_schemes(input_dir: str, output_dir: str):
    """Process all schemes with ultimate final extraction"""
    ...
    print("Processing schemes with ULTIMATE FINAL content extraction...")
    ...
    # Print final summary
    print(f"\n=== ULTIMATE FINAL EXTRACTION PROCESSING COMPLETE ===")
...
def main():
    ...
    output_directory = "/Users/priyankjairaj/Downloads/ctu-flowrag/ultimate_final_schemes"
    
    print("=== Ultimate Final Extraction Processor ===")
    print(f"Input directory: {input_directory}")
    print(f"Output directory: {output_directory}")
    print("Processing schemes with ULTIMATE FINAL content extraction...")
    print("Target: 60%+ extraction efficiency!")
