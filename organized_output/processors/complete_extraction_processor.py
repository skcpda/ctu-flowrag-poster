#!/usr/bin/env python3
"""
Complete Extraction Processor - Extract EVERYTHING from JSON including all nested structures
"""
...
def extract_everything_from_json(json_data: Dict) -> Dict[str, Any]:
    """Extract EVERYTHING possible from JSON - COMPLETE VERSION"""
    scheme = {}
    ...
    # ADDITIONAL FIELDS - Extract everything else
...
def generate_complete_description(scheme: Dict[str, Any]) -> str:
...
def process_single_scheme(input_file: Path, output_dir: Path) -> Dict[str, Any]:
    """Process a single scheme file with complete extraction"""
    result = {
        'success': False,
        'scheme_name': 'Unknown',
        'error': None,
    ...
    try:
        ...
        description = generate_complete_description(scheme)
        ...
        metadata = {
            ...
            'template_used': 'complete_extraction',
            ...
            'all_extracted_fields': list(scheme.keys())
        }
...
def process_all_schemes(input_dir: str, output_dir: str):
    """Process all schemes with complete extraction"""
    ...
    print("Processing schemes with COMPLETE content extraction...")
    ...
    # Print final summary
    print(f"\n=== COMPLETE EXTRACTION PROCESSING COMPLETE ===")
...
def main():
    ...
    output_directory = "/Users/priyankjairaj/Downloads/ctu-flowrag/complete_schemes"
    
    print("=== Complete Extraction Processor ===")
