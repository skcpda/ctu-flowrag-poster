#!/usr/bin/env python3
"""
Advanced Scheme Processor with Jinja2 Template Support
"""
...
def main():
    ...
    print("=== Advanced Scheme Processor ===")
    print(f"Input directory: {input_directory}")
    print(f"Output directory: {output_directory}")
    print("Processing schemes individually with advanced template formatting...")
